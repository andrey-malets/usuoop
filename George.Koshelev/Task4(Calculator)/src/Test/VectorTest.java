...
public class VectorTest extends TestCase {
	...
	public void testAdd() throws OperationNotSupportedException, DifferentDimensions, ZeroDiscr {
	...
	public void testMul() throws OperationNotSupportedException, ZeroDiscr{
		Random rn = new Random();
		int lim = rn.nextInt(100)+1;
		ArrayList<RealValue> a = new ArrayList<RealValue>();
		ArrayList<RealValue> b = new ArrayList<RealValue>();
	...
	public void testDiv() throws OperationNotSupportedException, DivisionByZeroException, ZeroDiscr{
		Random rn = new Random();
		int lim = rn.nextInt(100)+1;
		ArrayList<RealValue> a = new ArrayList<RealValue>();
		ArrayList<RealValue> b = new ArrayList<RealValue>();
